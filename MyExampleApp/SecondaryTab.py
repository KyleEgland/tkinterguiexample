...
# MyExampleApp
# SecondaryTab
# Originally copied from the PrimaryTab file this tab is intended to show the
# subscriber model by updating a value between the primary and secondary tabs
import tkinter as tk
import tkinter.ttk as ttk


class SecondaryTab(tk.Frame):
